...
* [aws_ami](cases/aws_ami/README.rst), more examples:
  - [run ami_with_tags_filter](cases/aws_ami/run ami_with_tags_filter/README.rst)
...
* [aws_instance](cases/aws_instance/README.rst), more examples:
  ...
  - [run instance with_data_source_ami](cases/aws_instance/run instance with_data_source_ami/README.rst)
